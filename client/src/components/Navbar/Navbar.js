    ...
    <div className={'container-fluid header'}>
      <div className={'row p-3'}>
        ...
        <div className="col-12 col-lg-3 d-flex justify-content-center">
          <SearchIcon className="SearchIcon" style={{ color: "#111" }} fontSize="large" />
          <form className="col-10 navForm" onSubmit={movieSearchFunc} >
            <input className={'col-12 header_input'} placeholder="Search Movies" value={query} type="text" onChange={(e) => setQuery(e.target.value)} />
          </form>
